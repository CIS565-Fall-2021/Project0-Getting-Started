...
enum Value { ViewportConstantSlot = 0, Count };
}

// The sample supports both Raytracing Fallback Layer and DirectX Raytracing
// APIs. This is purely for demonstration purposes to show where the API
// differences are. Real-world applications will implement only one or the
// other. Fallback Layer uses DirectX Raytracing if a driver and OS supports it.
